...
export default function Navbar() {
  ...
  const dropdownList = [
    ...
    { text: "Login", href: "/posts" },
    { text: "Logout", href: "/posts" },
  ];
  return (
    <nav className="py-10">
      <Container>
        <div className="flex items-center">
          ...
          <div
            className={`lg:w-7/12 w-full bg-gradient-to-b from-gray-600 to-gray-900 lg:bg-none lg:static top-0 h-full lg:h-auto fixed lg:p-0 p-10 transition-all ${
          ...
          >
            ...
            <ul className="lg:space-x-10  flex lg:items-center flex-col lg:flex-row space-y-4  lg:space-y-0">
              ...
              <li className="relative">
                ...
                {dropdown && (
                  <ul className="absolute w-[200px] mt-4 shadow-2xl ">
                    {dropdownList.map(({ text, href }) => (
                      <li key={text}>
                        <Link href={href} legacyBehavior>
                          <a className="flex py-3 px-6 bg-gray-800 border-b border-white-5 hover:bg-gray-700/60 last:border-b-0">
                            {text}
                          </a>
                        </Link>
                      </li>
          ...
          >
            <button
              className="absolute top-3 right-16 lg:hidden "
            ...
            <input
              type="text"
              className="bg-gray-700 py-3 px-6 lg:rounded-full  rounded-lg w-full"
              placeholder="Search..."
            />
          </div>
        </div>
